...
Für die Arbeit wurden jedoch nur die Ordner **Data_Preparation**, **LSTM_Model** und **Graphics** verwendet. Die anderen beiden Ordner enthalten trainierte XGboost Modelle und Sammlungen der Fehlermetriken für die LSTM-Modelle. Die Programme in letzteren Ordnern wurden jedoch nicht für die schriftliche Arbeit verwendet.
...
5. Create_Training_Dataset.py: 
   ...
   Nimmt die von Ausreissern bereinigten Dataframes aus Air_Data_gather.py und Meteo_Data_gather.py und ersetzt NaN-Werte durch KNN-Imputation. Speichert die bereinigten Trainingsdatensätze im Ordner *Training_Dataset* ab.
...
6. Plot_persistance.py:

   Hier kann die stündliche Änderungsrate der Ozonkonzentration oder eines andere Features im Trainings- und Testdatensatz berechnet werden. 
