...
model_configs = [{'Type':1,'to_predict_feature':to_predict_feature, 'LSTM_l1_dimension':10, 'look_back':12, 'features': ['Datum',to_predict_feature], 'batchsize':32},
                 {'Type':1,'to_predict_feature':to_predict_feature, 'LSTM_l1_dimension':20, 'look_back':12, 'features': ['Datum',to_predict_feature], 'batchsize':32},
                 {'Type':1,'to_predict_feature':to_predict_feature, 'LSTM_l1_dimension':30, 'look_back':12, 'features': ['Datum',to_predict_feature], 'batchsize':32},
                 {'Type':1,'to_predict_feature':to_predict_feature, 'LSTM_l1_dimension':10, 'look_back':24, 'features': ['Datum',to_predict_feature], 'batchsize':32},
                 {'Type':1,'to_predict_feature':to_predict_feature, 'LSTM_l1_dimension':20, 'look_back':24, 'features': ['Datum',to_predict_feature], 'batchsize':32},
                 {'Type':1,'to_predict_feature':to_predict_feature, 'LSTM_l1_dimension':30, 'look_back':24, 'features': ['Datum',to_predict_feature], 'batchsize':32},
                 {'Type':1,'to_predict_feature':to_predict_feature, 'LSTM_l1_dimension':10, 'look_back':36, 'features': ['Datum',to_predict_feature], 'batchsize':32},
                 {'Type':1,'to_predict_feature':to_predict_feature, 'LSTM_l1_dimension':20, 'look_back':36, 'features': ['Datum',to_predict_feature], 'batchsize':32},
                 {'Type':1,'to_predict_feature':to_predict_feature, 'LSTM_l1_dimension':30, 'look_back':36, 'features': ['Datum',to_predict_feature], 'batchsize':32},

                 {'Type':1,'to_predict_feature':to_predict_feature, 'LSTM_l1_dimension':10, 'look_back':12, 'features': features, 'batchsize':32},
                 {'Type':1,'to_predict_feature':to_predict_feature, 'LSTM_l1_dimension':20, 'look_back':12, 'features': features, 'batchsize':32},
                 {'Type':1,'to_predict_feature':to_predict_feature, 'LSTM_l1_dimension':30, 'look_back':12, 'features': features, 'batchsize':32},
                 {'Type':1,'to_predict_feature':to_predict_feature, 'LSTM_l1_dimension':10, 'look_back':24, 'features': features, 'batchsize':32},
                 {'Type':1,'to_predict_feature':to_predict_feature, 'LSTM_l1_dimension':20, 'look_back':24, 'features': features, 'batchsize':32},
                 {'Type':1,'to_predict_feature':to_predict_feature, 'LSTM_l1_dimension':30, 'look_back':24, 'features': features, 'batchsize':32},
                 {'Type':1,'to_predict_feature':to_predict_feature, 'LSTM_l1_dimension':10, 'look_back':36, 'features': features, 'batchsize':32},
                 {'Type':1,'to_predict_feature':to_predict_feature, 'LSTM_l1_dimension':20, 'look_back':36, 'features': features, 'batchsize':32},
                 {'Type':1,'to_predict_feature':to_predict_feature, 'LSTM_l1_dimension':30, 'look_back':36, 'features': features, 'batchsize':32}
...
for model in model_configs:
    if model['Type'] == 1:
        run(model['Type'],model['look_back'],1,model['LSTM_l1_dimension'],0, model['batchsize'], 30, model['to_predict_feature'], model['features'])

    elif model['Type'] == 2:
         run(model['Type'],model['look_back'],1,model['LSTM_l1_dimension'],model['LSTM_l2_dimension'], model['batchsize'], 30, model['to_predict_feature'], model['features'])
